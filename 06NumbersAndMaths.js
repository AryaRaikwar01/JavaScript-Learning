const score =new Number (999)
console.log(score)  

const NewScore = new Number(190)
...
const array1 = [2, 3, 1,99,72,22,21,9,232];

console.log(Math.min(...array1));
// toString() method converts the number to a string. The length property returns the length of a string.
...
// Math.min() returns the smallest number in an array. It can take any number of arguments. The spread operator (...) is used to expand the array into individual arguments.
...
// otherNumber.toPrecision(3) // Output - 1.12e+3 (exponential value)   //Quite a TRICKY ONE
...
console.log("Lets Fucking GOOOOOOOOOOOOOOO" )

// Question to pring a random number between 10 and 20 
// The Solution ✌️
...
console.log(Math.floor(Math.random() * (k2 - k + 1)) + k)